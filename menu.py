...
class Menu():
    def __init__(self, controller):
        ...
        # Register event from controller
...
class MainMenu(Menu):
    ...
    def __init__(self, controller):
        ...
        self.buttons = []
        self.buttons.append(
            Button(self, self.start_press, MainMenu.S_MENU_MAIN, (351, 325, 649, 395), "images/menu/startbutton.png",
                   "images/menu/startbutton_hover.png"))
        self.buttons.append(
            Button(self, self.about_press, MainMenu.S_MENU_MAIN, (351, 410, 649, 480), "images/menu/aboutbutton.png",
                   "images/menu/aboutbutton_hover.png"))
        self.buttons.append(Button(self, self.settings_press, MainMenu.S_MENU_MAIN, (351, 495, 649, 565),
                                   "images/menu/settingsbutton.png", "images/menu/settingsbutton_hover.png"))
        self.buttons.append(
            Button(self, self.return_to_main, MainMenu.S_MENU_ABOUT, (351, 575, 649, 645), "images/menu/backbutton.png",
                   "images/menu/backbutton_hover.png"))
        self.buttons.append(Button(self, self.return_to_main, MainMenu.S_MENU_SETTINGS, (351, 575, 649, 645),
                                   "images/menu/backbutton.png", "images/menu/backbutton_hover.png"))
        self.buttons.append(Button(self, self.display_time_press, MainMenu.S_MENU_SETTINGS, (351, 475, 649, 545),
                                   "images/menu/displaytimebutton.png", "images/menu/displaytimebutton_hover.png"))

        self.sliders = []
        self.sliders.append(
            Slider(self, self.set_music_volume, MainMenu.S_MENU_SETTINGS, 351, 100, MUSIC_DEFAULT_VOLUME,
                   "Music Volume", "images/menu/knob.png", "images/menu/sliderbg.png"))
        self.sliders.append(
            Slider(self, self.set_gamefx_volume, MainMenu.S_MENU_SETTINGS, 351, 200, GAMEFX_DEFAULT_VOLUME,
                   "GameFX Volume", "images/menu/knob.png", "images/menu/sliderbg.png"))
        self.sliders.append(
            Slider(self, self.set_miscfx_volume, MainMenu.S_MENU_SETTINGS, 351, 300, MISCFX_DEFAULT_VOLUME,
                   "MiscFX Volume", "images/menu/knob.png", "images/menu/sliderbg.png"))
        self.sliders.append(Slider(self, self.set_master_volume, MainMenu.S_MENU_SETTINGS, 351, 400, 1, "Master Volume",
                                   "images/menu/knob.png", "images/menu/sliderbg.png"))
...
class PreGameMenu(Menu):
    ...
    def __init__(self, controller):
        ...
        self.buttons = []
        self.buttons.append(Button(self, self.startmap_grass, PreGameMenu.S_PREGAME, (25, 400, 325, 600),
                                   "images/menu/button_grass.png", "images/menu/button_grass_hover.png"))
        self.buttons.append(
            Button(self, self.startmap_sand, PreGameMenu.S_PREGAME, (350, 400, 650, 600), "images/menu/button_sand.png",
                   "images/menu/button_sand_hover.png"))
    ...
    def draw(self):
        ...
        self.controller.screen.blit(self.controller.font.render(self.player2.upper(), True, (255, 255, 255)),
                                    (355, 250))
        ...
        self.controller.screen.blit(
            self.controller.font.render("PLAYER 1 - ENTER A NAME AND PRESS ENTER", True, (0, 0, 0)), (25, 80))
        self.controller.screen.blit(
            self.controller.font.render("PLAYER 2 - ENTER A NAME AND PRESS ENTER", True, (0, 0, 0)), (25, 110))
    ...
    def checkwrite(self, event):
        if pygame.key.name(event.key) not in (
...
class BetweenGameMenu(Menu):
    ...
    def __init__(self, controller):
        ...
        self.buttons = []
        self.buttons.append(Button(self, self.continue_press, BetweenGameMenu.S_BETWEENGAME, (351, 325, 649, 395),
                                   "images/menu/startnext.png", "images/menu/startnext_hover.png"))
    ...
    def draw(self):
        ...
        self.controller.screen.blit(self.controller.scorefont.render(
            str(self.controller.stats.data[self.controller.all_player_names[0]].get('score', 0)) + " - " + str(
                self.controller.stats.data[self.controller.all_player_names[1]].get('score', 0)), True,
            (255, 255, 255)), (460, 420))
...
class AfterGameMenu(Menu):
    ...
    def __init__(self, controller):
        ...
        self.buttons = []
        self.buttons.append(
            Button(self, self.quit, AfterGameMenu.S_AFTERGAME, (351, 325, 649, 395), "images/menu/exitbutton.png",
                   "images/menu/exitbutton_hover.png"))

        self.state = AfterGameMenu.S_AFTERGAME

    def draw(self):
        Menu.draw(self)
        self.controller.screen.blit(self.controller.scorefont.render(self.controller.agents[0].name + " win the game!", True, (255, 255, 255)), (360, 220))
...
class Slider():
    ...
    def draw(self):
        if self.menu.state == self.active_state:
            ...
            self.screen.blit(
                self.menu.controller.font.render(self.caption + " " + str(int(self.get_value())), True, (0, 0, 0)), (
                    self.bg_x + self.bg_image.get_width() / 2 - 8 * len(self.caption),
                    self.bg_y - self.bg_image.get_height() / 2))
