...
class World():
    ...
    def generate(self):
        """Generate the game world and its objects"""
...
class Area(WorldObject):
    ...
    def area(self):
        ...
        for i in range(0, random.randint(15, 30)):
            phi = random.randint(int((self.circles[-1].phi - math.radians(random.randint(1, 360)))),
                                 int((self.circles[-1].phi + math.radians(random.randint(1, 360)))))
